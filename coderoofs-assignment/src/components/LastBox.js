...
function LastBox() {
  return (
    <div className="lastBox-main">
      <div className="lastBox-main2">
        <h1>EXTRA ART STYLES</h1>
        <div className="card-box2 new-card-box2">
...
var lastBtnData = ["Starry Night", "Water Lillis", "Art Nouveau", "Nighthawks", "Italian Masters", "Photo-journalism", "Afropop", "MangaX Watercolor", "Political"]